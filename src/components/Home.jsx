...
function Home() {
  ...
  return (
    <>
      <div className="min-h-screen bg-goodview bg-cover bg-no-repeat bg-center flex justify-center p-4">
        ...
        <div className="w-full max-w-md bg-white/30 dark:bg-gray-900/30 backdrop-blur-xl border border-white/20 shadow-2xl rounded-2xl p-6">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <h1 className="text-2xl font-bold text-gray-800 dark:text-white tracking-[0.3em] uppercase">
              Habit Tracker
            </h1>
